...
\item Download the files from our Moodle course onto your computer.
...
\begin{document}
% now we can use commands from graphicx and amsmath 
\end{document}
\end{minted}
\end{itemize}
\end{frame}
...
\begin{itemize}
Add the graphicx package in the preamble 
