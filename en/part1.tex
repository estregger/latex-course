...
\begin{frame}[fragile]{\insertsubsection{} with \wlogo}
\begin{itemize}
...
\item Name the new project ``Chignecto Isthmus''
\vskip 2ex
...
\item Download the chignecto\_bridge.jpg file from Moodle.
\item Upload it to your project.
\end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Add an image}
\begin{verbatim}
Add the graphicx package below the documentclass command 
if it was not added when you opened your project:
\usepackage{graphicx}
...
\includegraphics[
  width=0.5\textwidth]{chignecto_bridge.jpg}
\end{verbatim}
